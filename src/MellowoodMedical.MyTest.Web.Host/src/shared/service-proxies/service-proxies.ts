...
export class CMSServiceServiceProxy {
     ...
     * @return Success
     */
    insertOrUpdateCMSContent(input: CreateContentDto | null | undefined): Observable<Content> {
        let url_ = this.baseUrl + "/api/services/app/CMSServices/InsertOrUpdateCMSContent";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<Content>><any>_observableThrow(e);
                }
            } else
                return <Observable<Content>><any>_observableThrow(response_);
        }));
    }

    protected processInsertOrUpdateCMSContent(response: HttpResponseBase): Observable<Content> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = resultData200 ? Content.fromJS(resultData200) : new Content();
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<Content>(<any>null);
    }
    ...
    getCMSContent(id: number | null | undefined): Observable<ContentDto> {
        let url_ = this.baseUrl + "/api/services/app/CMSServices/GetCMSContent?";
        if (id !== undefined)
     ...
     * @return Success
     */
    getAll(): Observable<ListResultDtoOfGetContentListDto> {
        let url_ = this.baseUrl + "/api/services/app/CMSServices/GetAll";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ListResultDtoOfGetContentListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ListResultDtoOfGetContentListDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<ListResultDtoOfGetContentListDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = resultData200 ? ListResultDtoOfGetContentListDto.fromJS(resultData200) : new ListResultDtoOfGetContentListDto();
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListResultDtoOfGetContentListDto>(<any>null);
    }
}
...
export class ContentDto implements IContentDetailOutput {
    id: number | undefined;
...
export class ListResultDtoOfGetContentListDto implements IListResultDtoOfGetContentListDto {
    items: GetContentListDto[] | undefined;

    constructor(data?: IListResultDtoOfGetContentListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                ...
                for (let item of data["items"])
                    this.items.push(GetContentListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfGetContentListDto {
        data = typeof data === 'object' ? data : {};
        let result = new ListResultDtoOfGetContentListDto();
        result.init(data);
        return result;
    }
    ...
    clone(): ListResultDtoOfGetContentListDto {
        const json = this.toJSON();
        let result = new ListResultDtoOfGetContentListDto();
        result.init(json);
        return result;
...
export interface IListResultDtoOfGetContentListDto {
    items: GetContentListDto[] | undefined;
}

export class GetContentListDto implements ICMSContentListDTO {
    id: number | undefined;
    pageName: string | undefined;
    pageContent: string | undefined;
    ...
    static fromJS(data: any): GetContentListDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetContentListDto();
        result.init(data);
        return result;
    }
